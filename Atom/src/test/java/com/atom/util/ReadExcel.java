...
public class ReadExcel {
	...
	public LinkedList<String> name = readExcel(0);
	public LinkedList<String> email = readExcel(1);
	public LinkedList<String> phone = readExcel(2);
	public LinkedList<String> amount = readExcel(3);
	public LinkedList<String> cardNumbers = readExcel(4);
	public LinkedList<String> cardExp = readExcel(5);
	public LinkedList<String> cardHolderName = readExcel(6);
	public LinkedList<String> cardCVV = readExcel(7);
	public LinkedList<String> cardPin = readExcel(8);
	public LinkedList<String> cardBankName = readExcel(9);
...
//		System.out.println(test);
	...
	public static void writeExcelData(ArrayList<Object[]> data) throws IOException {
		try {
			...
			r1c1.setCellValue("Customer's Name");
			...
			r1c11.setCellValue("Merchant Txn Id");
			XSSFCell r1c12 = row1.createCell(11);
			r1c12.setCellValue("Atom Txn ID");
			XSSFCell r1c13 = row1.createCell(12);
			r1c13.setCellValue("Bank Ref No");
			XSSFCell r1c14 = row1.createCell(13);
			r1c14.setCellValue("Client Code");
			XSSFCell r1c15 = row1.createCell(14);
			r1c15.setCellValue("Date Time");
